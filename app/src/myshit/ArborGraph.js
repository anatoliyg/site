define(function(require, exports, module){
	...
	ApborGraph.prototype.init = function() {
		...
		//console.dir(self);
		var theCanvas = $('canvas.famous-surface')[0];
		var context = this.getContext('2d');

		theCanvas.setAttribute('width', '900');
		theCanvas.setAttribute('height', '520');
		// theCanvas.setAttribute('width', ''+self.defaultSize[0]+'');
		// theCanvas.setAttribute('height', ''+self.defaultSize[1]+'');
		...
		function init() {
			...
			turnSpeed = 2*Math.PI/500; //the sphere will rotate at this speed (one complete rotation every 1600 frames).
			turnAngle = 0; //initial angle
			
			timer = setInterval(onTimer, 10/100);
		}
